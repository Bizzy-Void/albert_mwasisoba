...
function WorkItem({ work, setIframeUrl, toggleModal }) {
    ...
    return (
        <div>
            <div
                className={`rounded-2xl py-1 group/work bg-description_bg  w-full  duration-150`}
            >
                ...
                <div
                    className={`mx-2 my-2 ${showDetails && "pb-2"} pt-2 px-2 bg-transparent duration-150 group-hover/work:bg-description_bg rounded-xl`}
                >
