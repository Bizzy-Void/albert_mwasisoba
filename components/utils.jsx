...
const works = [
    {
        ...
        details:
            "Official website for Varsitymart. An innovative e-commerce platform designed to revolutionize online shopping in Tanzania. This project, a collaborative effort with my friend, focuses on creating a seamless and efficient user experience while providing unique features tailored to the local market. Created with [Vite React](https://vitejs.dev/), and [TailwindCSS](https://tailwindcss.com/)",
    },
    {
        title: "Drips4Geeks",
        banners: [
        ...
        details:
            "Official website for Drips4Geeks Store. This is an online store where every geek can find their style. Created with [NextJS](https://nextjs.org/docs), [Shadcn UI](https://ui.shadcn.com/docs), and [TailwindCSS](https://tailwindcss.com/)",
    },
    // {
    ...
    // },
    {
        ...
        details:
            "This is my personal portfolio website. Created with [NextJS](https://nextjs.org/)",
    },
    {
        ...
        details:
            "Official website for *All Wheels Experience*. A company which focus on providing tourist with services when visiting national parks in Tanzania. Created with [ReactJS](https://reactjs.org/)",
    },
    {
        ...
        url: null,
        details:
            "Collection of some graphic designs I have done for various clients for the past few years.",
    },
]
